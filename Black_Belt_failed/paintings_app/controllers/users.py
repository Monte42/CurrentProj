...
def login_register_page():
    if session.get('user_id'): return redirect('/painints')
...
def register_user():
    if user.User.create_user(request.form):return redirect('/paintings')
...
def login():
    if user.User.login_user(request.form):return redirect('/paintings')
